...
public class HttpGatewayServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws IOException {
        ...
        try {
            String targetResponse = cachingHttpClientService.doGet(uriBuilder.build(), credentialsProvider,
